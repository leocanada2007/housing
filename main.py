...
def tab_commission():
  ...
  first_10k = st.number_input("Enter Coop Commission (aka Buyer Agent Commission) on First $100,000 in %", value = 3.255, format = %.2f)
  first_10k = first_10k/100
  remaining = st.number_input("Enter Coop Commission (aka Buyer Agent Commission) on Balance in %", value = 1.1625, format = %.2f)
